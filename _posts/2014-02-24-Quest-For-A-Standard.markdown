...
This need for a standard is extensively discussed in the article by Captain Edward H. Lundquist, Proceedings Magazine, February 2014. <a href="http://www.usni.org/magazines/proceedings/2014-02/search-standard-answer" target="_blank">Link</a> (subscription required).
